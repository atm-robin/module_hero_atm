 ...
 */
class hero_atmbox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "hero_atm@hero_atm";
    public $boxlabel;
    public $depends = array("hero_atm");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/hero_atm/class/hero_atm.class.php";
